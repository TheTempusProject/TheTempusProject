		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
			<div class="panel panel-success">
						...
						<div class=" col-md-9 col-lg-9 "> 
							<table class="table table-user-success">
								<tbody>
									...
									<tr>
										<td>Group:</td>
										<td><a href="{BASE}/admin/groups/view/{user_group}">{group_name}</a></td>
									</tr>
									{/ADMIN}
									<tr>
										<td>Registered:</td>
				...
				<div class="panel-footer">
					<a href="{base}usercp/messages/new_message/{USERNAME}" data-original-title="Broadcast Message" data-toggle="tooltip" type="button" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-envelope"></i></a>
					{ADMIN}
